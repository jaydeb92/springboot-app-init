...
<script type="text/javascript">
	$(document).ready(function() {
		$('#modalSave').click(function() {
			var dataBack = $("#exampleModal #env").val();
			var dataBack1 = $("#exampleModal #url").val();
			/* $("#exampleModal #url").val(); */
			$('#result').html(dataBack);
			$('#result1').html(dataBack1);
		});
	});
</script>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">ENV:</label> <input
							type="text" class="form-control" form="saveForm" id="env"
							name="env" />
					</div>
					<div class="form-group">
						<label for="message-text" class="col-form-label">URL:</label>
						<textarea class="form-control" form="saveForm" id="url" name="url"></textarea>
					</div>
					<!-- </form> -->
				</div>
